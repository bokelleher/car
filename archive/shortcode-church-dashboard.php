...
function car_render_church_dashboard() {
    if (!is_user_logged_in()) {
        ...
        return '<p>You must be <a href="' . esc_url($login_url) . '">logged in</a> to view this report.</p>';
    }
...
<div class="car-filter-row">
    <form method="get" class="car-date-filter-form">
    ...
    <form method="post" action="<?php echo admin_url('admin-post.php'); ?>" class="car-export-form">
    ...
    <table class="church-dashboard-table">
        ...
        while ($query->have_posts()): $query->the_post();
            ...
            <tr data-report-id="<?php echo esc_attr($post_id); ?>">
                ...
                <td contenteditable="<?php echo $is_editable ? 'true' : 'false'; ?>" class="editable" data-field="in_person"><?php echo esc_html(end($in_person)); ?></td>
                <td contenteditable="<?php echo $is_editable ? 'true' : 'false'; ?>" class="editable" data-field="online"><?php echo esc_html(end($online)); ?></td>
                <td contenteditable="<?php echo $is_editable ? 'true' : 'false'; ?>" class="editable" data-field="discipleship"><?php echo esc_html(end($discipleship)); ?></td>
...
.car-date-filter-form label {
    margin-right: 0.5rem;
}

.car-export-form input[type="submit"] {
    height: 2.5em;
}
...
add_shortcode('test_debug_shortcode', function() {
    return '<strong>✅ Shortcodes are firing!</strong>';
});
