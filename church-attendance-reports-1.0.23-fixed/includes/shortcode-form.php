...
function car_render_attendance_form() {
    ...
    // Prevent duplicate submissions for the same church and date
    ...
    if (!empty($duplicate_check)) {
        echo '<p><strong>An attendance report has already been submitted for this church and date.</strong></p>';
        return ob_get_clean();
    }
